...
print("Bias: ")
print(classifier.layers[1].get_weights()[1][0])
print(classifier.layers[2].get_weights()[1][0])
...
print("wt1HL:",classifier.layers[2].get_weights()[0][:,0][0])
print("wt2HL:",classifier.layers[2].get_weights()[0][:,0][1])
print("wt3HL:",classifier.layers[2].get_weights()[0][:,0][2])